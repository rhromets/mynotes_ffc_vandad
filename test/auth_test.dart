...
import 'package:mynotes_ffc_vandad/services/auth/auth_provider.dart';
import 'package:mynotes_ffc_vandad/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test('User should be null initially', () {
